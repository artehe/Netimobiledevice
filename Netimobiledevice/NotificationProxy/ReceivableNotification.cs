...
public static class ReceivableNotification {
    /// <summary>
    /// All known receivable notifications.
    /// </summary>
    ...
    /// <summary>
    /// All receivable notifications, both the well-established ones above and the more
    /// experimental ones discovered through reverse engineering.
    /// </summary>
    [Experimental("NETIMOBILE001")]
    public static IReadOnlyList<string> AllExperimental { get; } = [
        .. All,
        ...
        dataUpdated,
        deviceOffersChanged,
        eligibilityoverridechanged,
        terminus,
        matchOperationStartAttempted,
        passcodeGracePeriodChanged,
        launchnotification,
        wristStateChanged,
        DonateNow,
        CloudSubscriptionFeatureChanged,
        CloudSubscriptionFeaturesOptInChanged,
        enabled,
        shutdowsoon,
        record,
        reset,
        server,
        LocatableStateReported,
        FCPauseRingsSampleChangedNotification,
        SettingsChanged,
        started,
        stopped,
        pairedDeviceExperimentsConfigChanged,
        ReportFactoryInstall,
        ApplicationsChanged,
        ...
        accountChanged,
        isLoggedIn,
        _managementStatusChangedForDomains,
        longerstringtarget,
        ActivationLockAllowedStateDidChange,
        profileListChanged,
        webContentFilterChanged,
        webContentFilterTypeChanged,
        lockScreenControlsDidChange,
        nowPlayingActivePlayersIsPlayingDidChange,
        ...
        translation_assets_ATOMIC_INSTANCE_DOWNLOADED,
        translation_assets_ATOMIC_INSTANCE_ELIMINATED,
        translation_assets_ATOMIC_INSTANCE_NO_ENTRIES,
        STARTUP_ACTIVATED,
        ASSET_VERSION_DOWNLOADED,
        cached_metadata_updated,
        MobileAsset_CoreTextAssets_ma_new_asset_installed,
        MobileAsset_EmbeddedSpeech_ma_new_asset_installed,
        MobileAsset_Font7_ma_cached_metadata_updated,
        MobileAsset_KextDenyList_ma_new_asset_installed,
        MobileAsset_SecureElementServiceAssets_ma_cached_metadata_updated,
        MobileAsset_SecureElementServiceAssets_ma_new_asset_installed,
        MobileAsset_SpeechEndpointAssets_cached_metadata_updated,
        MobileAsset_SpeechEndpointAssets_ma_cached_metadata_updated,
        MobileAsset_TTSAXResourceModelAssets_ma_new_asset_installed,
        MobileAsset_TimeZoneUpdate_ma_cached_metadata_updated,
        MobileAsset_TimeZoneUpdate_manew_asset_installed,
        MobileAsset_VoiceServices_CustomVoice_ma_new_asset_installed,
        MobileAsset_VoiceServices_GryphonVoice_ma_new_asset_installed,
        MobileAsset_VoiceServices_VoiceResources_ma_new_asset_installed,
        MobileAsset_VoiceServices_VoiceResources_new_asset_installed,
        MobileAsset_VoiceServicesVocalizerVoice_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerAssets_cached_metadata_updated,
        MobileAsset_VoiceTriggerAssets_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerAssets_ma_new_asset_installed,
        MobileAsset_VoiceTriggerAssets_new_asset_installed,
        MobileAsset_VoiceTriggerAssetsIPad_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerAssetsIPad_ma_new_asset_installed,
        MobileAsset_VoiceTriggerAssetsMarsh_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerAssetsMarsh_ma_new_asset_installed,
        MobileAsset_VoiceTriggerAssetsStudioDisplay_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerAssetsStudioDisplay_ma_new_asset_installed,
        MobileAsset_VoiceTriggerAssetsWatch_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerAssetsWatch_ma_new_asset_installed,
        MobileAsset_VoiceTriggerAssetsWatch_new_asset_installed,
        MobileAsset_VoiceTriggerHSAssets_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerHSAssets_ma_new_asset_installed,
        MobileAsset_VoiceTriggerHSAssetsIPad_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerHSAssetsIPad_ma_new_asset_installed,
        MobileAsset_VoiceTriggerHSAssetsWatch_ma_cached_metadata_updated,
        MobileAsset_VoiceTriggerHSAssetsWatch_ma_new_asset_installed,
        backgroundCellularAccessChanged,
        OSVersionChanged,
        Music_AllowsCellularDataDownloads,
        changed,
        SubmissionPreferenceChanged,
        ChangedRestrictionsEnabledStateNotification,
        ResetPrivacyWarningsNotification,
        mobileBackupStateChange,
        rollBackupDisabled,
        rollIfAged,
        rollNow,
        ProtectedCloudStorage_test_mobileBackupStateChange,
        updatedKeys,
        LockScreenDiscovery,
        SOSNotifyContactsReasonCinnamon,
        SOSNotifyContactsReasonKappa,
        SOSNotifyContactsReasonMandrake,
        SOSNotifyContactsReasonNewton,
        SOSNotifyContactsReasonSOSTrigger,
        reload_plugin,
        received,
        als,
        deviceUsageReport,
        ...
        submitted,
        undefined,
        CheckForCatalogChange,
        SUPreferencesChanged,
        TriggerBackgroundCheck,
        activeaccountchanged,
        StorefrontChanged,
        updatedVoices,
        connectionRequested,
        IdleScreenRefreshIntervalChanged,
        IdleScreenScreenSaverTypeChanged,
        PhotosSharingFilterChanged,
        RequestMemoriesRefresh,
        TVScreenSaverAssetServiceManagerUpdated,
        DefaultAppRelayTelephonySettingChanged,
        RemoveAllDynamicDictionariesNotification,
        application,
        now_playing,
        video,
        web_domain,
        ProfileStoreDidUpdate,
        DidRegisterSubscription,
        PlayHistoryUpdatedNotification,
        StoreAcquisitionCrossProcessNotification,
        UpNextRequestDidFinishNotification,
        accessibility_cache_darken_system_colors_enabled,
        color,
        contrast,
        legibility,
        colors,
        ...
        motion,
        status,
        accessibility_commandandcontrol_status,
        accessibility_enhance_background_contrast_status,
        accessibility_pointer_increased_contrast,
        accessibility_prefers_horizontal_text,
        accessibility_reduce_motion_status,
        point,
        accessibility_voiceovertouch_status,
        accessibility_zoomtouch_status,
        MFi4AccessoryDisconnected,
        passedMFi4Auth,
        privateListeningChanged,
        provision_biometrics,
        canceltasks,
        deviceKnowledge,
        iTunesActiveAccountDidChangeNotification,
        iTunesActiveStorefrontDidChangeNotification,
        launch,
        reconcile,
        backgroundstate,
        message,
        appplaceholdersyncd_replicatorclient_record,
        change,
        hidden,
        locked,
        ActivitySubEntitlementsCacheUpdated,
        AppStoreSubEntitlementsCacheUpdated,
        HWBundleSubEntitlementsCacheUpdated,
        MusicSubEntitlementsCacheUpdated,
        NewsSubEntitlementsCacheUpdated,
        PodcastSubEntitlementsCacheUpdated,
        TVSubEntitlementsCacheUpdated,
        iCloudSubEntitlementsCacheUpdated,
        app_vocabulary,
        didChange,
        assistant_domain_preferences_didChange,
        assistant_domain_priority_didChange,
        ...
        RecentsClearedNotification,
        calls_changed,
        idslaunchnotification,
        identificationentrieschanged,
        ...
        thermalChanged,
        siri_data_changed,
        chronod_replicator_message,
        chronod_replicator_record,
        almostfull,
        notfull,
        ProactivePredictionsBackup,
        kvstorechange,
        cmfsyncagent_kvstorechange,
        storedidchangeexternally,
        attach_notification,
        DataSettingsChangedNotification,
        commcenter_InternationalRoamingEDGE_changed,
        clientDidDisplayFavorites,
        BorealisToggled,
        IORunning,
        RoutingConfiguration,
        borealisTrigger,
        coreaudio_components_changed,
        created,
        coreduetd,
        coreduet_idslaunchnotification,
        duetexpertd,
        ...
        ReindexAllItems,
        ReindexAllItemsWithIdentifiers,
        auto_submit_preference_changed,
        tasking_changed,
        checkHolidayCalendarAccount,
        ping,
        datamigrationcompletecontinuerestore,
        migrationDidFinish,
        devicePostureChanged,
        longLivedTokenChanged,
        dmd_budget_didChange,
        dmd_iCloudAccount_didChange,
        appRefresh,
        internalSettingsChanged,
        BluetoothConnectedAnchor,
        CarPlayConnectedAnchor,
        ChargerConnectedAnchor,
        IdleTimeEndAnchor,
        WiredAudioDeviceConnectedAnchor,
        duetexpertd_ATXAnchorModel_invalidate_BluetoothConnectedAnchor,
        duetexpertd_ATXAnchorModel_invalidate_CarPlayConnectedAnchor,
        duetexpertd_ATXAnchorModel_invalidate_ChargerConnectedAnchor,
        duetexpertd_ATXAnchorModel_invalidate_IdleTimeEndAnchor,
        duetexpertd_ATXAnchorModel_invalidate_WiredAudioDeviceConnectedAnchor,
        duetexpertd_ATXMMAppPredictor_BluetoothConnectedAnchor,
        BluetoothDisconnectedAnchor,
        duetexpertd_ATXMMAppPredictor_CarPlayConnectedAnchor,
        CarPlayDisconnectedAnchor,
        duetexpertd_ATXMMAppPredictor_IdleTimeEndAnchor,
        duetexpertd_ATXMMAppPredictor_WiredAudioDeviceConnectedAnchor,
        WiredAudioDeviceDisconnectedAnchor,
        ATXScreenUnlockUpdateSource,
        appchangeprediction,
        appclipprediction,
        clientModelRefreshBlendingLayer,
        defaultsChanged,
        dockAppListCacheUpdate,
        activity,
        intent,
        feedbackavailable,
        homeScreenPageConfigCacheUpdate,
        audiodisconnect,
        bluetoothconnected,
        bluetoothdisconnect,
        carplayconnect,
        ...
        family_updated,
        FitnessAppInstalled,
        gamepolicy_daemon_launch,
        apple_geoservices_siri_data_changed,
        notification,
        notification_private,
        htse_state_changed,
        SleepDetectedActivity,
        SleepSessionEndRequest,
        AppleTVAccessoryAdded,
        multi_user_status_changed,
        speakersConfiguredChanged,
        televisionAccessoryAdded,
        multiuser,
        homed_user_cloud_share_wake_com_apple_applemediaservices_multiuser,
        qa,
        container,
        data,
        zonesharing,
        ...
        icloud_fmip_lostmode_enable,
        icloud_fmip_siri_data_changed,
        accessoryDidPair,
        selfbeaconchanged,
        icloudpairing_idslaunchnotification,
        idscredentials_idslaunchnotification,
        idsremoteurlconnection_idslaunchnotification,
        idstransfers_idslaunchnotification,
        prefchange,
        Recovered,
        displayStatus,
        backcamerapower,
        frontcamerapower,
        artworkDownloadsDidCompleteNotification,
        accountschanged,
        autodownloaddefaultschange,
        invalidatebags,
        complete,
        effaced,
        LockdownMode,
        ...
        sleepd,
        language_changed,
        liveactivitiesd_replicatorParticipant_message,
        liveactivitiesd_replicatorParticipant_record,
        localprefschanged,
        appreset,
        authorization,
        bufferedDevicesReceived,
        came_up,
        connected,
        disconnected,
        exit,
        toVehicular,
        Prefs,
        allowpasscodemodificationchanged,
        effectivesettingschanged,
        managedorginfochanged,
        passcodechanged,
        restrictionchanged,
        media_entities_siri_data_changed,
        media_podcasts_siri_data_changed,
        displayFilterSettingsChanged,
        disk_image_mounted,
        first_unlock,
        lock_status,
        BonjourPairingServiceChanged,
        BonjourServiceChanged,
        activation_state,
        device_name_changed,
        host_paired,
        trusted_host_attached,
        storage_unmounted,
        invitationalertschanged,
        calendarsExcludedFromNotifications,
        overlayCalendarID,
        weekStart,
        timezonechanged,
        mobileipod_prefsChanged,
        displayvalueschanged,
        keeplocalstatechanged,
        librarychanged,
        libraryimportdidfinish,
        noncontentspropertieschanged,
        poll,
        allowFindMyFriendsModification,
        refreshui,
        ICPLStateChanged,
        PLNotificationKeepOriginalsChanged,
        bedtimetest,
        chargetest,
        diagnostics,
        goodmorningtest,
        ...
        waketest,
        wakeuptest,
        generative_experiences_readiness,
        defaults,
        LibraryCollectionTargetMapData_changed,
        devicedidpair,
        devicedidunpair,
        initialSyncDidComplete,
        paireddevicedidchangecapabilities,
        paireddevicedidchangeversion,
        watchdidbecomeactive,
        startPredicting,
        wakeUpForHypothesisUpdate,
        terminal,
        app_paths_changed,
        apps_changed,
        nehelper_init,
        phs,
        networkserviceproxy_reset,
        nfcacd_multitag_state_change,
        os_eligibility_domain_change,
        aluminum,
        chromium,
        greymatter,
        manganese,
        ...
        bag,
        clearData,
        pasteboard_notify_changed,
        focalappchanged,
        DidUpdateAutonamingUserFeedback,
        network_service,
        photostream_idslaunchnotification,
        ...
        smartcharge,
        stridecalibration,
        private_restrict_post_MobileBackup_backgroundCellularAccessChanged,
        namedEntitiesInvalidated,
        weather,
        proactive_queries_clearData,
        databaseChange,
        setupdone,
        setupexited,
        pushproxy_idslaunchnotification,
        CompanionLinkDeviceAdded,
        CompanionLinkDeviceRemoved,
        rapport_prefsChanged,
        nano_preferences_sync,
        storeChanged,
        accountsChanged,
        remotepairingdevice_host_paired,
        devicesChanged,
        hipuncap,
        sbd_kvstorechange,
        screensharing_idslaunchnotification,
        forceupdate,
        kvstorechange3,
        itembackup,
        groupsupdated,
        ...
        viewschanged,
        PCS,
        security_view_change_SE_PTC,
        security_view_ready_SE_PTC,
        screenIsLocked,
        screenIsUnlocked,
        daemon_wakeup_request,
        runner_prewarm_request,
        ShortcutsCloudKitAccountAddedNotification,
        ShortcutsCloudKitAccountModifiedNotification,
        DataDidUpdateNotification,
        siri_client_state_DynamiteClientState_siri_data_changed,
        deleted,
        siri_cloud_synch_changed,
        requested,
        audio_app_signals_update,
        donate,
        updated,
        quiet,
        Overrides,
        ...
        test,
        defaultschanged,
        sockpuppet_applications_updated,
        startInstall,
        SUCoreConfigScheduledScan,
        autoDownload,
        autoDownloadEnd,
        autoInstallEnd,
        autoInstallUnlock,
        ...
        rollbackReboot,
        splatAutoScan,
        SyndicatedContentDeleted,
        SyndicatedContentRefreshed,
        spotlightui_prefschanged,
        finishedstartup,
        hasBlankedScreen,
        lockstate,
        pluggedin,
        ...
        prepareForQuery,
        settingsChanged,
        materialLinkQualityChange,
        sysdiagnoseStarted,
        sysdiagnoseStopped,
        accpowersources_attach,
        source,
        clock_set,
        network_change,
        hostname,
        power_button_notification,
        desktopUp,
        system,
        lowpowermode,
        auto_disabled,
        ...
        cold,
        timezone,
        verylowdiskspace_system,
        tcc_access_changed,
        fakeincomingmessage,
        fakeoutgoingmessage,
        voicemailcallended,
        ageAwareMitigationsEnabled,
        timezoneprefschanged,
        timezonesync_idslaunchnotification,
        touchsetupd_launch,
        FREEZER_POLICIES,
        NETWORK_SERVICE_PROXY_CONFIG_UPDATE,
        SIRI_DICTATION_ASSETS,
        SIRI_TEXT_TO_SPEECH,
        SIRI_UNDERSTANDING_ASR_ASSISTANT,
        SIRI_UNDERSTANDING_ATTENTION_ASSETS,
        ...
        appRemoved,
        updateAppVisibility,
        BTLEServer_personalizationNeeded,
        UARPUpdaterServiceHID_personalizationNeeded,
        migrationCompleted,
        ReloadService,
        VVVerifierCheckpointDictionaryChanged,
        voicemail_changed,
        voice_update,
        asset_force_update,
        EarlyDetect,
        PHSProfileModified,
        ConnectionChanged,
        RemoteDarwin_EarlyDetect,
        XPCRestarted,
        enablePolicyChanged,
        wake_up,
        disabled,
        webinspectord_enabled,
        dismissed,
        wirelessinsightsd_anonymity,
        wirelessproximity_launch,
        app,
